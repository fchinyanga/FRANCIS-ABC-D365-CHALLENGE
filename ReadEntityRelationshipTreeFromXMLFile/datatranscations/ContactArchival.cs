...
namespace ReadEntityRelationshipTreeFromXMLFile.datatranscations
{
  public class ContactArchival
  {

    private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
    public static void ArchiveContact(CrmServiceClient crmServiceClient, string connStr)
    {
      ...
      for (int i = 0; i < enColl.Entities.Count; i++)
      {
        ...
        if ((int)result == 0)
        {
          ...
          try
          {
            ...
            log.Info($"ContactId={ContactId}\t Client age= {age}\t" +
          ...
          {
            log.Info("Record for \t" + ContactId + "\t was not recorded into the database because of \t" + ex.Message);
          }
          #endregion
        }
        else
        {
          ...
          log.Info("\tContact with contactId\t" + ContactId + "\t already exist and will be updated");
          try
          {
          ...
          {
            log.Info("Record for \t" + ContactId + "\t was not updated into the database because of \t" + ex.Message);
          }
          #endregion
        }
        /*if (i == 2)
